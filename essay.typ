...
+ Симметричное шифрование
  ...
  - AES (Advanced Encription Standard) является стандартом шифрования, принятым
    правительством США.
  - Blowfish - алгоритм шифрования с ключём переменной длинны,
    разработанный Брюсам Шнайнером в 1993 году. Часто этот алгоритм предоставляет лучшую
...
+ OpenSSH является наиболее популярной открытой имплементацией SSH и является частью
  ...
  и большинство известных протоколов аутентификации. Рабатает на всех операционных
  системах типа Unix и имеет версии, портируемые на Windows ОС.
...
+ LibreSSH - это вилка (fork) проекта OpenSSH, направленная на повышение безопасности
  и упрощение работы проекта. В отличии от OpenSSH Libre-версия закончила поддержку
  многих устаревших возможностей и протоколов и фокусируется на наиболее современных
  и инновационных нововведениях. Поддерживает Widows, Unix/Linux и macOS.
